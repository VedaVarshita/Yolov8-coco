...
def train(args, params):
        ...
        with open('weights/step.csv', 'w') as f:
            ...
            for epoch in range(args.epochs):
                ...
                if args.local_rank == 0:
                    ...
                    mlflow.log_metrics({'mAP': str(f'{last[1]:.3f}'),
                                    'epoch': str(epoch + 1).zfill(3),
                                    'mAP_50': str(f'{last[0]:.3f}')}, step = epoch)
                    f.flush()
    ...
    mlflow.log_artifact('weights/step.csv')
    if args.local_rank == 0:
        util.strip_optimizer('./weights/best.pt')  # strip optimizers
        util.strip_optimizer('./weights/last.pt')  # strip optimizers
        mlflow.log_artifact('weights/best.pt')
        mlflow.log_artifact('weights/last.pt')
...
def test(args, params, model=None):
    ...
    loader = data.DataLoader(dataset, 8, False, num_workers=32,
